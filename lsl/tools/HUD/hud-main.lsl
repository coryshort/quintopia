...
//  Added support for attached storage such as SF Pitchfork
//  Fixed not showing correct 'inspect' values for some items
//  Added DEBUG setting in config notecard so can turn on debugging that way
